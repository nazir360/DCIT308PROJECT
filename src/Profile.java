...
public class Profile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(463, 280, -1, -1));
        getContentPane().add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(463, 302, 300, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(name.equals("")){
         ...
         JOptionPane.showMessageDialog(null, "Address field is required");
            ...
            ps.executeUpdate();
            JOptionPane.showMessageDialog(null, "Profile successfullu update !");   
            setVisible(false);
